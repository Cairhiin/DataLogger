<template>
    <AppLayout title="Dashboard">
        ...
        text-zinc-600 dark:text-zinc-300">Latest URL Events</h3>
                    ...
                    py-2 rounded-t text-zinc-600 dark:text-zinc-300 mb-2">Latest Members (if ADMIN)</h3>
                        <ul>
                            <li v-for="member in users" class="grid grid-cols-3 px-4 pb-2 dark:text-zinc-200">
                                <div>{{ member.name }}</div>
